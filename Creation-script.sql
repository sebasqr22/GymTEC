...
CREATE TABLE INSTRUCTOR (
	...
	Id_servicio INT NOT NULL,
	Num_clase INT NOT NULL,
	PRIMARY KEY (Cedula_empleado, Id_servicio, Num_clase)
);
...
ADD CONSTRAINT FK_Instructor_Employee FOREIGN KEY (Cedula_empleado) REFERENCES EMPLEADO(Cedula);

ALTER TABLE INSTRUCTOR
ADD CONSTRAINT FK_Instructor_Class FOREIGN KEY (Id_servicio, Num_clase) REFERENCES CLASE(Id_servicio, Num_clase);
